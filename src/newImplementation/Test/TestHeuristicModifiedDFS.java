...
public class TestHeuristicModifiedDFS {
    ...
    public void testOnePositiveBaseAlgo(){
        ...
        assertEquals(2 ,  SolutionHeuristics.computeSolution(sampleGraph , 2));
    ...
    public void TestOneNegative(){
        ...
        assertNotEquals(1 ,  SolutionHeuristics.computeSolution(sampleGraph , 2));
    }
    ...
    public void TestTwoPositive(){
        ...
        assertEquals(1, SolutionHeuristics.computeSolution(sampleGraph, 2));
    }
    ...
    public void TestTwoPositiveTwo(){
        ...
        assertEquals(1, SolutionHeuristics.computeSolution(sampleGraph, 1));
    }
    ...
    public void varyComponentSizeConnectedLinearGraph(){
        ...
        for(int counter = 0 ; counter<=sample.vertexSet().size() ; counter++){
            assertEquals((int)preComputedMinDeletionSets.get(counter) , SolutionHeuristics.computeSolution(sample , counter));
        }
    }
    ...
    public void varyComponentSizeDisconnectedLinearGraph(){
        ...
        for(int counter = 0 ; counter< precomputedMinimumDeletionSets.size()  ; counter++){
            assertEquals((int)precomputedMinimumDeletionSets.get(counter) , SolutionHeuristics.computeSolution(graph, counter));
        }
    ...
    public void varyComponentSizeConnectedCompleteGraphTest(){
        ...
        for(int counter = 0 ; counter<=sample.vertexSet().size() ; counter++){
            assertEquals((int)preComputedSolutions.get(counter) , SolutionHeuristics.computeSolution(sample ,counter));
        }
        ...
        */
        ...
        for(int counter = 0 ; counter< allGraphs.size(); counter++){
            ...
            for(int componentSizes = 0 ; componentSizes<= numberOfVertices ; componentSizes++){
                ...
                int minDeletionSet = SolutionHeuristics.computeSolution(graph , componentSizes) ;
